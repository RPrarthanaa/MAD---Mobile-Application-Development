...
public class CustomizeGameAiSettings extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customize_game_ai);
        ...
        radioGroup1.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                if (colorStrPlayer1.equals(colorStrPlayer2)) {
                    Toast.makeText(CustomizeGameAiSettings.this, "Players Can't Be Same Color", Toast.LENGTH_SHORT).show();
                    redPlayer1.setChecked(true);
                }
            }
        });
